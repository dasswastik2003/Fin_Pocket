...
//           <p className="section-badge test-badge">Testimonials</p>
//           <h2 className="sec-heading test-head">What our users say</h2>
//           <p className="sec-description test-desc">
...
//               <div key={testimonial.id} className="swiper-slide testimonial-card">
//                 <div className="info">
...
import 'swiper/css';
import 'swiper/css/pagination';
import styles from '@/styles/faq/testimonialS.module.css';
// import "@/styles/faq/testimonialS.css"
